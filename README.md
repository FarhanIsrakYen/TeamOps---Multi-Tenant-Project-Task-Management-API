...
- OpenAPI: `GET http://localhost:8080/openapi.yaml`
...
See [architecture](docs/architecture.md), [feature modules and Go dependency injection](docs/modules.md), [database design](docs/database.md), [security](docs/security.md), and the embedded [OpenAPI document](backend/internal/platform/openapi/openapi.yaml).
